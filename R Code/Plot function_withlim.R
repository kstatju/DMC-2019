...
# plot_var_list_1 = plot_all(dt = combin_dt1, varname = varname1, yvar = yaxisvar, 
...
# limfile = read.csv("D:/ISU/Data Mining Cup DMC/DMC 2019/Plot/xylim_1.csv", sep = ",")
...
# plot_var_list_2 = plot_all(dt = combin_dt1, varname = varname1, yvar = yaxisvar, 
#                            fillvar = "dttype",testplot = F,maxorder = 3,
#                            path = file_save_path)
...
plot_var_list_3 = plot_all(dt = combin_dt1, varname = varname1, yvar = yaxisvar, 
                           fillvar = "dttype", xylimr = limfile, 
                           sidebyside = T, testplot = T, maxorder = 3,
                           path = file_save_path)
...
hist(log(train$lineItemVoidsPerPosition))
