...
Parallel_function <- function(i, Train, e){
  ...
  cutoff        = seq(.999999,0.85, length.out = 200)# probability cutoff for predicting fraud
  ...
  Config_Fda   = function(){
    ...
    Exp_Params[[2]] = c(3.5, 4, 4.5)                          #penalty
    Exp_Params[[3]] = c(80)                                  #nk
    Exp_Params[[4]] = c(0.0001)                              #thresh
    Exp_Params[[5]] = c(3, 5, 8)                        #minspan
    Exp_Params[[6]] = c(70, 75)                       #endspan
    ...
    Exp_Params[[12]] = c(6, 7, 8)                        #Adjust.endspan Max = 10
